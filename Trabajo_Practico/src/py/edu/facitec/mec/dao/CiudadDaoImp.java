...
public class CiudadDaoImp implements CiudadDao{
    ...
    public Ciudad recuperarPorCodigo(int codigo) {
        ...
        String sql = "SELECT codigo, nombre, iso, estado FROM public.ciudades WHERE codigo="+codigo+";";
        
        //abrir una conexion
        ConexionManager.conectar();
        //crear un objeto de Ciudad
        Ciudad ciudad = null;
    ...
    public List<Ciudad> recuperarPorFiltro(String filtro) {
        ...
        String sql = "SELECT codigo, nombre, iso, estado "
